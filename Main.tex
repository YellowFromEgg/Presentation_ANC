...
%     \begin{align*}
%         z(t) = \underline{x}(t_0) - (a - b) \int_{t_0}^{t} z(\tau)\, d\tau
%     \end{align*}
%     \begin{align*}
%         \dot{z}(t) = -(a - b)\,z(t), \quad z(t_0) = \underline{x}(t_0)
%     \end{align*}

%     \textbf{Solution:}
%     \begin{align*}
%         z(t) = \underline{x}(t_0)\, e^{-(a - b)(t - t_0)}
%     \end{align*}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        % Since $\dot{x}(t) \leq -(a - b)\,x(t)$ and $\dot{z}(t) = -(a - b)\,z(t)$, with $x(t_0) = z(t_0)$, the Comparison Lemma states that:
        \begin{align*}
...
\begin{frame}
    ...
    \begin{tcolorbox}[title=Problem: Analyze Boundedness of a Perturbed Mass-Spring-Damper-System]
		\vspace{-0.4cm}
        \begin{align*}
            \dot{\underline{x}}_1 &= x_2 \\ % Position
